                  ...
                  <div class="col-md-6 ">
                    ...
                    <div class="theme-search-results-item _mb-10 theme-search-results-item-">
                      <div class="theme-search-results-item-preview">
                        <a class="theme-search-results-item-mask-link" href="{{ url('/shop_detail/'.$u->id) }}"></a>
                        <div class="row" data-gutter="20">
                          ...
                          <div class="col-md-8 ">
                            ...
                            <div class="theme-search-results-item-car-location">
                              ...
                              <a class="btn btn-primary-inverse  theme-search-results-item-price-btn" href="{{ url('/shop_detail/'.$u->id) }}">ดูข้อมูลเพิ่ม</a>
                            </div>
                          </div>
                        </div>
                      </div>
